...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        CGFloat categoryH = categoryW * 0.5f;
        ...
        for (int i = 0; i < categoryArray.count; i++) {
            ...
            CGFloat menuBtnY = 0;
            UIButton *menuBtn = [[UIButton alloc] initWithFrame:CGRectMake(menuBtnX, menuBtnY, categoryW, categoryH)];
            
            
            NSMutableAttributedString *menuNameAttributeString = [[NSMutableAttributedString alloc] initWithString:categoryArray[i]
                    attributes:@{NSForegroundColorAttributeName:[UIColor blackColor],
                                 NSFontAttributeName:FontSize18,
                                 NSParagraphStyleAttributeName:paragraphStyle}];
            
            [menuBtn setAttributedTitle:menuNameAttributeString forState:UIControlStateNormal];
