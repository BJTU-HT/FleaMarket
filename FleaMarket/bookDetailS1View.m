...
-(CGFloat)layoutViewSelf:(NSMutableDictionary *)mudic{
    ...
    CGFloat report_y = originalPrice_y;
    CGFloat report_w = 60.0f;
    CGFloat report_h = 20.0f;
    _bookReportBtn.frame = CGRectMake(report_x, report_y, report_w, report_h);
    ...
    _remarkLabel.text = @"推荐使用";
    
    //float depre_x = remark_x + remarkWidth;
    float depre_x = screenWidthPCH - margin - remarkWidth;
