...
-(float)layoutViewSelf:(NSString *)contentText userInfo:(BmobIMUserInfo *)userInfo{
    ...
    BmobUser *loginUser = [BmobUser getCurrentUser];
    [self.imageBtn sd_setBackgroundImageWithURL:[NSURL URLWithString:[loginUser objectForKey:@"avatar"]] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"icon_default_face@2x.png"]];
    ...
    self.contentLabel.frame = CGRectMake(contentLabel_X_offset, contentLabel_Y_offset, titleSize.width + 10, titleSize.height + 10);
    //_contentLabel.backgroundColor = [UIColor colorWithRed:0 green:255.0/255.0 blue:0 alpha:1.0];
    _contentLabel.backgroundColor = [UIColor colorWithRed:118/255.0 green:238.0/255.0 blue:0.0/255.0 alpha:1.0];

    height = contentLabel_Y_offset + titleSize.height + 10 + margin;
...
-(float)layoutViewOther: (NSString *)contentText userInfo:(BmobIMUserInfo *)userInfo{
    ...
    float imageBtn_Y_Offset = timeLabel_Y_Offset + margin +timeLabelHeight;
    self.imageBtn.frame = CGRectMake(imageBtn_X_Offset, imageBtn_Y_Offset, imageBtnWidth, imageBtnHeight);
    [self.imageBtn sd_setBackgroundImageWithURL:[NSURL URLWithString: userInfo.avatar] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"icon_default_face@2x.png"]];
