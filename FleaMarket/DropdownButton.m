...
- (UIButton *)makeButton:(NSString *) title andIndex:(int)index{
    ...
    float padding = (width - (_image.size.width + [title sizeWithAttributes:attr].width)) / 2;
    ...
    [button setImageEdgeInsets:UIEdgeInsetsMake(11, [title sizeWithAttributes:attr].width + padding + 5, 11, 0)];
